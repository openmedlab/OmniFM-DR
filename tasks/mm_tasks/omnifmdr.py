...
from data.mm_data.omnifmdr_dataset import OmniFMDrDataset
...
@dataclass
class OmniFMDrConfig(OFAConfig):
    eval_acc: bool = field(
...
@register_task("omnifm_dr", dataclass=OmniFMDrConfig)
class OmniFMDrTask(OFATask):
    def __init__(self, cfg: OmniFMDrConfig, src_dict, tgt_dict):
    ...
    def load_dataset(self, split, epoch=1, combine=False, **kwargs):
        ...
        self.datasets[split] = OmniFMDrDataset(
            split,
            dataset,
            self.bpe,
            self.src_dict,
