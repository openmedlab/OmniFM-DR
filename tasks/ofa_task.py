...
class OFATask(FairseqTask):
    ...
    def setup_task(cls, cfg: DictConfig, **kwargs):
        ...
        # # build dictionaries
        # print(f"Start build dic...")
        # all_files_path = '/data/niziyu/projects/DR/third_party/OFA_bak/nick_utils/mimic_reports'
        # reports = [os.path.join(all_files_path, f) for f in os.listdir(all_files_path)]
        # print(f"There are reports: {len(reports)}")
        # tmp_dict = cls.build_dictionary(reports)
        # print(f"Start save...")
        # tmp_dict.save('/data/niziyu/projects/DR/third_party/OFA_bak/nick_utils/mimic_dict_2.txt')
        # print(f"Save good")
        # exit()
